...
//   return (
//     <div className="min-h-screen flex flex-col md:flex-row items-center justify-center bg-[#F8F8EC] px-4 py-12 relative">
//       {/* Ảnh minh họa bên trái */}
//       <img
//         src={coverImage}
//         alt="Ecology Illustration"
//         className="hidden md:block w-full max-w-[700px] mr-8"
//       />

//       {/* Phần tiêu đề + form */}
//       <div className="flex flex-col items-center md:items-start justify-center space-y-10 max-w-xl w-full">
        
//         {/* Tiêu đề */}
//         <div className="text-left w-full md:w-[90%] ml-[-2rem]">
//           <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-green-700 leading-tight whitespace-nowrap">
//             Ecology & Environment
//           </h1>
